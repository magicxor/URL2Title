...
uses
  TestFramework, System.SysUtils, uWebScraper, System.Variants, Generics.Collections,
  System.Generics.Defaults, System.Math, System.Types, System.Net.URLClient,
  System.NetEncoding, System.Threading, System.Classes, System.RegularExpressions,
  System.UITypes, System.Net.HttpClientComponent;
...
var
  ...
  str: string;
const
  URLs: array of string = ['http://stackoverflow.com/', // HTTP with EN title
...
begin
  ...
  try
    ...
    try
      // FWebScraper.GetTitlesFromURLs(URLStrings, ResultStrings); // todo: tests
    finally
